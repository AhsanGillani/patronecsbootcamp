...
export default function InstructorDashboard() {
  ...
  const getComponent = () => {
    switch (activeTab) {
      ...
      case "students":
        return <SubmittedQuizzes />; // Student Progress
      case "analytics":
        return <CourseInsights />;
      case "insights":
        return <CourseInsights />; // backward compatibility
      case "blogs":
        return <BlogManager />; // legacy
      case "notifications":
        return <NotificationCenter />; // legacy
      case "submissions":
        return <SubmittedQuizzes />; // legacy
      default:
        return <InstructorProfile />;
    }
  };
