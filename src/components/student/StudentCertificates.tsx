...
const PATRONECS_LOGO_SVG =
  "https://cdn.prod.website-files.com/63eb79f4ab031d09e95a842f/6630f0f8c4d054dad1f951d9_Logo%20(7).svg";
...
export function StudentCertificates() {
      ...
      const allCertificates = [
        ...
        ...(completedData || [])
          ...
          .map((enrollment) => ({
            ...
            certificate_number: `CERT-${new Date().getFullYear()}-${String(
  ...
  const downloadCertificatePDF = async (certificate: Certificate) => {
    try {
      ...
      const backgroundUrl =
        "https://d1csarkz8obe9u.cloudfront.net/posterpreviews/certificate-background-template-design-8673c42070573c71a94b91e9b8c45afc_screen.jpg?ts=1697121145";
      try {
      ...
      // Recipient
      const studentName =
        (profile as any)?.full_name || user?.email || "Student";
      ...
      // Footer brand
      page.drawText("Patronecs", {
        x: width - 140,
        y: 60,
        size: 14,
        font: fontBold,
        color: rgb(0.12, 0.33, 0.87),
      });
