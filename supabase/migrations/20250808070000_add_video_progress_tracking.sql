-- Migration: Add Video Progress Tracking to Lesson Progress System
-- Date: 2025-08-08
-- Description: This migration adds comprehensive progress tracking for video, PDF, text, and quiz content
...
GRANT EXECUTE ON FUNCTION public.calculate_lesson_completion(UUID, UUID) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.update_enrollment_progress() TO authenticated;

-- Success message
SELECT 'Migration completed successfully! Video progress tracking system is now active.' as status;
